main_labelling <-
function(peak_table, compound, labelling, mass_shift, RT, RT_shift, chrom_width, initial_abundance=NA){
  # Main function of the package. It computes the estimated X abundances of each sample, returning an object of the class "labelling".
