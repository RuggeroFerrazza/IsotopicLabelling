...
Worth of note, 
ic variants of the species of interest. M+0 is the species where all the atoms (including
X) are the lighest isotopes; in M+1 one light isotope is replaced by its heaviest
counterpart, and so forth.isotopic_pattern 5
nX The number of X atoms. In other words, the number of atoms with unkwown
isotopic distribution.
nTOT The total number of atoms of the labeling element (either H+X or C+X).
