...
Another important object is the "target" vector, which contains the exact masses of all the possible isotopologues of the species of interest coming from the labeling isotope. In the example, the [PC 32:2 + H]<sup>+</sup> adduct has 40 carbon atoms, and therefore the possible isotopologues coming from <sup>13</sup>C span a 41 mass range: from the monoisotopic species, where all the C atoms are <sup>12</sup>C, to the species where all the 40 C atoms are <sup>13</sup>C. However, since the isotopic patterns 
